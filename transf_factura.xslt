    ...
    <xsl:template match="pedido">
        <html>
            <body>
                ...
                <p>Fecha de Compra: <xsl:value-of select="detalle_pedido/fecha_compra"/></p>
                <p>Número de Pedido: <xsl:value-of select="detalle_pedido/numero_pedido"/></p>
                <table border="1">
                    <tr bgcolor="#6495ed">
                ...
                <p>Total de la Factura: <xsl:value-of select="detalle_pedido/total_factura"/></p>
            </body>
        </html>
    </xsl:template>
